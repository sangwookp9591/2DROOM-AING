    ...
    <WorldShell>
      <article className="doc">
        <header className="cover" data-room="cover">
          ...
          <p className="lead">
            2019년부터 개발자로 일했습니다. 도로공사·KT 같은 큰 시스템에서 시작해, 앱과 영상 서비스를 만들고,
            지금은 손님이 보는 화면부터 눈에 안 보이는 서버까지 혼자 이을 수 있습니다.
            문제가 터진 뒤에 수습하기보다 막힐 자리를 먼저 찾아 지우는 편이고,
            요즘은 AI를 일하는 과정 안에 넣어 팀이 반복하는 일을 줄이는 데 씁니다.
            가장 최근에는 의료관광 서비스를 만드는 회사에서 아홉 달 동안 일했습니다.
          </p>
          <dl className="metrics">
            ...
            <div><dt>5,240</dt><dd>가장 최근 아홉 달에 남긴 변경 기록</dd></div>
          </dl>
        </header>
